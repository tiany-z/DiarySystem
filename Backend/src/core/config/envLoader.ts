...
export function parseCliEnvFile(args: Array<string> = process.argv): string | null {
...
export function loadEnvFile(envPath?: string): StandardResult<Record<string, string>> {
  try {
...
export function printStartupError(serviceName: string, reason: string) {
...
export function printStartupSuccess(serviceName: string, infoLines: string[]) {
