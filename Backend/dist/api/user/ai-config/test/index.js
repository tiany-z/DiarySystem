import { decryptApiKey, executeQuery, normalizeCompletionsUrl, returnError, returnSuccess, tryCatchErrorToString, } from "../../../../core/index.js";
export const api = {
    ...
    handler: async (reqCtx, ctx) => {
        try {
            ...
            if (!targetBaseUrl || !targetModel || !targetApiKey) {
                ...
                if (userRow) {
                    if (!targetBaseUrl && userRow.ai_base_url)
                        targetBaseUrl = userRow.ai_base_url;
                    if (!targetModel && userRow.ai_model_name)
                        targetModel = userRow.ai_model_name;
