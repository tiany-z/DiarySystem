...
import { delKV, executeQuery, returnError, returnSuccess, tryCatchErrorToString, } from "../../../core/index.js";
...
export const api = {
    ...
    handler: async (reqCtx, ctx) => {
        try {
            ...
            // 执行数据库更新
            const updateRes = await executeQuery("UPDATE users SET avatar = ? WHERE id = ?", [avatarUrl, currentUserId]);
